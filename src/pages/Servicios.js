...
function Servicios() {
    ...
    return (
        <div className="min-h-screen relative pt-32 pb-4">
            <div className="max-w-[90rem] w-full mx-auto px-6 relative z-10 flex flex-col items-center">
                ...
                <div className="text-center mb-12">
                    ...
                    <span
                        className={`
                            inline-flex items-center border px-3.5 py-1 rounded-full mb-5
                    ...
                    <h1 className="text-3xl md:text-4xl lg:text-5xl font-inter font-semibold tracking-tight-apple text-white leading-tight mb-2 transition-all duration-1000 ease-out delay-100">
                        <span className={isVisible ? 'opacity-100' : 'opacity-0'}>
                            ¿Qué podemos hacer por ti?
                        </span>
                    </h1>
                    <p className="text-sm md:text-base font-inter font-normal text-gray-400 mb-8 max-w-lg mx-auto transition-all duration-1000 ease-out delay-200">
                        <span className={isVisible ? 'opacity-100' : 'opacity-0'}>
                    ...
                    <button
                        ...
                        className="
                            group inline-flex items-center gap-2 mx-auto px-8 py-3 bg-logo-blue text-white
                            text-[15px] font-inter font-semibold rounded-full
                            hover:bg-[#003a80]
                            shadow-[0_12px_40px_-10px_rgba(0,76,160,0.7)]
                            hover:shadow-[0_16px_50px_-10px_rgba(0,76,160,1)]
                            active:scale-[0.97]
                ...
                {/* ── Cards Grid ── */}
                <div className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                    {services.map((svc) => (
                        <ServiceCard
                            key={svc.id}
                            icon={svc.icon}
